...
def get_poisoned_dataset(dataset_name, batch_size=128, augmented=True, num_workers=4, root="./data", normalization=None,
                         poisoning_rate=0.0, trigger_label=1, trigger_size=5, trigger_path="./toolkit/triggers/trigger_white.png"):
